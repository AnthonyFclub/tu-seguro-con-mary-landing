            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 max-w-5xl mx-auto gap-8">
                    {services.map((service, i) => (
                        <ScrollReveal key={service.id} delay={i * 0.2} direction={i % 2 === 0 ? "left" : "right"}>
                            <div
                                className={`group relative overflow-hidden bg-slate-50 rounded-3xl pt-8 pb-12 px-6 lg:px-10 border border-slate-100 shadow-sm hover:shadow-[0_0_30px_rgba(184,134,11,0.3)] hover:border-brand-gold/30 hover:bg-white transition-all duration-500 hover:-translate-y-2 flex flex-col items-center text-center h-full`}
                            >
